...
--
-- Host: localhost    Database: pcmaker
-- ------------------------------------------------------
...
--
-- Table structure for table `pcpower`
--
...
--
-- Dumping data for table `pcpower`
--

LOCK TABLES `pcpower` WRITE;
/*!40000 ALTER TABLE `pcpower` DISABLE KEYS */;
/*!40000 ALTER TABLE `pcpower` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-12-05  7:34:35
